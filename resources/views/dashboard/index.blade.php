...
<head>
    ...
    <title>Dashboard - Plus36 Networks SMS</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-white shadow-lg">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    <a href="#" class="sidebar-item flex items-center px-4 py-3 text-gray-700 rounded-lg bg-indigo-50 text-indigo-600">
        ...
        <div class="flex-1 overflow-y-auto">
            ...
            <div class="bg-white shadow-sm px-8 py-4 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    <div class="relative">
                        <input type="text" placeholder="Search..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                        ...
                        <p class="text-gray-600 text-sm">Revenue Collected</p>
                    </div>
                </div>
                ...
                <div class="grid lg:grid-cols-2 gap-8 mb-8">
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        <h3 class="text-lg font-semibold mb-4">Student Enrollment Trend</h3>
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">$500.00</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">$450.00</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
